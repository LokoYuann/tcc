...
CREATE TABLE IF NOT EXISTS `funcionario` (
  ...
  `funcao_func` varchar(30) DEFAULT NULL,
...
-- Copiando dados para a tabela dailyevent.funcionario: ~5 rows (aproximadamente)
DELETE FROM `funcionario`;
INSERT INTO `funcionario` (`id_func`, `mat_func`, `funcao_func`, `nome_func`, `nasc_func`, `sexo_func`, `tel_func`, `cpf_func`, `cep`, `id_ue`) VALUES
	(1, 1, 'jk', 'asd', '2022-07-10', 'f', '2353245', '43634', 20231020, 1),
	(2, 2, NULL, 'bobo', NULL, 'm', NULL, '346346', 25266006, 2),
	(5, 2247785, 'CEO dos map', 'pedro', '1640-09-15', 'm', '2197485922', '4523623', 25266006, 1),
	(8, 123123, 'aeorpk', 'aofkpsaopfk', '1541-04-12', 'm', '123', '364567457', 21311281, 1),
	(10, 1423, 'gbrt', 'juuao', '2022-09-14', 'f', '28498237598', '456', 23550050, 17);
...
INSERT INTO `usuarios` (`id_func`, `usuario`, `senha`, `nivel`, `foto`) VALUES
	(1, 'admin1', '123', 1, ''),
	(2, 'admin2', '123', 2, 'gettyimages-1374042265-2048x2048.webp'),
	(10, 'dsadsa', '', 1, '');
