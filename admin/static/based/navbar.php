	...
	<div class="navbar-collapse collapse">
		<ul class="navbar-nav navbar-align">
			<li class="nav-item dropdown">
				...
				<img src="/admin/static/img/perfil/<?php if(!empty($fotow["foto"])){echo $fotow["foto"].".jpg";}else{echo "profile.webp";} ?> "  class="avatar img-fluid rounded me-1" alt="<?php echo $_SESSION['UsuarioNome']?>" /> <span class="text-dark"><?php echo $_SESSION['UsuarioNome']?></span></a>
