	...
	<br>
		...
		<div class="row"> 
			...
			<div class="form-group col-md-3">
				<label class="font-info" for="funcao_func">Função</label>
			...
			<div class="form-group col-md-3">
				<label class="font-info" for="nasc_func">Data de nascimento</label>
		...
		<div class="form-group col-md-2">
			...
			<div class="form-group col-md-3">
				<label class="font-info" for="cpf_func">CPF</label>
		...
		<div class="row"> 
			<div class="form-group col-md-2">
				<label class="font-info" for="cep">CEP</label>
				<input type="text" name="cep" class="form-control cep" id="cep" placeholder="00000-000" required>
			</div>
			
			<div class="form-group col-md-3">
				<label class="font-info" for="numero">Número Residêncial</label>
				<input type="text" name="numero" class="form-control" id="numero" required>
			</div>
			
			<div class="form-group col-md-4">
				<label class="font-info" for="sexo_func">Sexo</label><br>
				<label class="mas-fem" class="radio-inline">
				<input  type="radio" name="sexo_func" value="m" required>Masculino
				</label>
				<label class="font-info" class="radio-inline">
				<input  type="radio" name="sexo_func" value="f" required>Feminino
				</label>
			</div>
		</div>
		<hr />
